...
def _():
    ...
    name = "Naledi"  # Replace with your name
    age = 20  # Replace with your age
    height = 1.59  # Replace with your height
...
def _():
    ...
    favorite_foods = ["sushi", "braai","pizza","lamb","roast"]  # Add your foods here

    # TODO: Print the first food
    print(f"First food:{favorite_foods[0]}")  # Fix this line

    # TODO: Print the last food
    print(f"Last food:{favorite_foods [4]} ")  # Fix this line
...
def _():
    ...
    temperature = 35  # Try changing this value
